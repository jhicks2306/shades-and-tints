...
export function Stepper({ value = 1, min = 1, max = Infinity, step: stepAmount = 1, onChange }: Props) {
    const step = (direction: -1 | 1) => onChange(clamp(value + (stepAmount * direction), min, max))
        ...
        <div className="stepper">
            <input
                ...
                onChange={event => {
                    ...
                    const value = isNumber(numberValue) ? numberValue : min
